<?php include './header_sourcing_rh.php'; ?>
...
<div id="srh_principale">
    ...
    <div id="foot_pres1">
        <img src="/images/logo_cf.png" id="oss_log1"/>
    </div>
    <div id="foot_pres2">
        <img src="/images/logo_vit.png" id="oss_log2"/>
    </div>
    <div id="foot_pres3">
        <img src="/images/logo_srh.png" id="oss_log3"/>
    </div>
...
<?php include './footer_sourcing_rh.php'; ?>